...
// - initialization order don't matter before main
// - don't use the config system to do initialization
// - only source code that can touch the variable is where it is declared
