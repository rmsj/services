...
// we can use here because:
// 1-initialisation order doesn'' matter before main
// 2- we don't need the config system to do the initialisation
// 3- only this code, in this file will make use of it.
...
// when order of initialisation matters, we should not use init() function - we can create a Init (capital letter I)
// and then call it manually from main, using the order that matters.
// because go uses the alphabetical order on a package to run the init() functions
func init() {
